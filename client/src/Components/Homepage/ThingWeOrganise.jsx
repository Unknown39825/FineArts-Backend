        ...
        <>
            ...
            <div className="container">
                ...
                <div className="site-content">
                    ...
                    <div className="posts">
                        {workshop.length > 0 ? (
                            workshop.map((data) => <PostContent key={data._id}  data={data} />)
                        ) : (
                            <PostContent />
                    ...
                    <aside className="sidebar">
                        ...
                        <div className="category">
                            ...
                            <ul className="list">
                                {events.length>0?(
                                    events.map((event) => <EventList key={event._id}  data={event}/>)
                                ):(
                                    <EventList/>
                                )}
                            </ul>
                        ...
                        <div className="popular-post">
                            ...
                            {events.length > 0 ? (
                                events.map((event) => <ConfluEvents key={event._id}  data={event} />)
                            ) : (
                                <ConfluEvents />
                            )}
                        ...
                        <div className="newsletter">
                            ...
                            <div className="form-element">
                                <form target="_blank" method="POST"
                                    ...
                                    <input type="email" required name="entry.882243583" id="" className="input-element" placeholder="Email" />
