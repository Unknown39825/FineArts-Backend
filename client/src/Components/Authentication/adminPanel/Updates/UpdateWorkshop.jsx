...
export default function UpdateWorkshop(props) {
  ...
  const onSubmit = (e) => {
    ...
    if (
      ...
      EventPost.desc.trim() !== "" &&
      EventPost.imglink.trim() !== "" &&
      EventPost.author.trim() !== ""
    ) {
      postEvent();
    } else {
