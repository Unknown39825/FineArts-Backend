                ...
                <div>
                    ...
                    <div className="form">
                        <form className="text-left m-2 p-5 text-white bg-dark rounded mt-5">
                            ...
                            <div controlId="">
                                <label><b>Event Link</b></label>
                                <input className="input" type="text" name="link" value={EventPost.link} onChange={handleChange} placeholder="" />
                            </div>
                            ...
                            <button variant="primary" className="btn" onClick={onSubmit}>{id !== "new" ? ("update") : ("create")}Event</button>
